...
if __name__ == "__main__":
    ...
    parser.add_argument("--keywords", default="E:\programming\PyLearn-SajjadAemmi\Assignment44\Pinterest-Crawler\keywords.txt", help="path to input image")
    parser.add_argument('--output', help='output dir', default='E:\programming\PyLearn-SajjadAemmi\Assignment44\Pinterest-Crawler\photos', type=str)
    parser.add_argument("-nw", '--number-of-words', help='number of keywords for search', default=1, type=int)
    ...
    for item in combinations(keywords, args.number_of_words):
        ...
        while True:
            configs = PinterestConfig(search_keywords=keyword,  # Search word
                                    file_lengths=500,  # total number of images to download (default = "100")

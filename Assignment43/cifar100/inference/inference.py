...
parser = argparse.ArgumentParser(description='CIFAR100 dataset - Ali Yaghoubian')
...
if args.model == 'MLP':
    model = load_model('../models/cifar100_mlp.h5')
elif args.model == 'CNN':
    model = load_model('../models/cifar100_cnn.h5')

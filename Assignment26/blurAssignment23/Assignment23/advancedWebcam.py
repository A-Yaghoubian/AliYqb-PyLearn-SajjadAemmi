...
face_detector = cv2.CascadeClassifier("blurAssignment23/Assignment23/haarcascade_frontalface_default.xml")
lEye_detector = cv2.CascadeClassifier("blurAssignment23/Assignment23/haarcascade_lefteye_2splits.xml")
rEye_detector = cv2.CascadeClassifier("blurAssignment23/Assignment23/haarcascade_righteye_2splits.xml")
smile_detector = cv2.CascadeClassifier("blurAssignment23/Assignment23/haarcascade_smile.xml")
